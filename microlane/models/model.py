# Model Super class is the parent class for other model classes
# Provides basic functions for initializing the model
# Need to pass the model configuration to the initialize function and would ensure it initializes at the right port
...
from microlane.schemas.config import Model as ModelConfig
...
class Model:
    ...
    def restart(self, container_id, model: ModelConfig) -> None:
        ...
        self.wait_for_ready(model.port)
