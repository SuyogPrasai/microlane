...
def samples_request_to_samples(samples_request: List[SampleRequest]) -> List[Sample]:
    return [ sample_request_to_sample(sample_request) for sample_request in samples_request]
